...
SOURCECRAFT_API_BASE_URL = env.str("SOURCECRAFT_API_BASE_URL", "")
SOURCECRAFT_API_FILE_BASE_URL = env.str("SOURCECRAFT_API_FILE_BASE_URL", "")
SOURCECRAFT_API_APPSEC_BASE_URL = env.str("SOURCECRAFT_API_APPSEC_BASE_URL", "")
SOURCECRAFT_API_TOKEN = env.str("SOURCECRAFT_API_TOKEN", "")
SOURCECRAFT_GIT_BASE_URL = env.str("SOURCECRAFT_GIT_BASE_URL", "")
